...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DELETE FROM main_flightcost';
    EXECUTE IMMEDIATE 'DELETE FROM main_paymentstatus';
    EXECUTE IMMEDIATE 'DELETE FROM main_reservation';
    EXECUTE IMMEDIATE 'DELETE FROM main_seatdetails';
    EXECUTE IMMEDIATE 'DELETE FROM main_serviceoffering';
    EXECUTE IMMEDIATE 'DELETE FROM main_passenger';
    EXECUTE IMMEDIATE 'DELETE FROM main_flightdetails';
    EXECUTE IMMEDIATE 'DELETE FROM main_flightservice';
    EXECUTE IMMEDIATE 'DELETE FROM main_travelclass';
    EXECUTE IMMEDIATE 'DELETE FROM main_airport';
...
BEGIN
    ...
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('KHI', 'Karachi', 'Pakistan');
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('LHE', 'Lahore', 'Pakistan');
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('ISB', 'Islamabad', 'Pakistan');
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('PEW', 'Peshawar', 'Pakistan');
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('UET', 'Quetta', 'Pakistan');
    INSERT INTO main_airport (airport_id, airport_city, airport_country) VALUES ('MUX', 'Multan', 'Pakistan');
...
BEGIN
    ...
    INSERT INTO main_travelclass (travel_class_id, name, capacity) VALUES ('ECO', 'Economy', 150);
    INSERT INTO main_travelclass (travel_class_id, name, capacity) VALUES ('BUS', 'Business', 50);
    INSERT INTO main_travelclass (travel_class_id, name, capacity) VALUES ('FIR', 'First', 20);
...
BEGIN
    ...
    INSERT INTO main_flightservice (service_id, service_name) VALUES ('MEAL', 'Meal');
    INSERT INTO main_flightservice (service_id, service_name) VALUES ('WIFI', 'Wi-Fi');
    INSERT INTO main_flightservice (service_id, service_name) VALUES ('ENT', 'In-flight Entertainment');
    INSERT INTO main_flightservice (service_id, service_name) VALUES ('EXL', 'Extra Legroom');
    INSERT INTO main_flightservice (service_id, service_name) VALUES ('PRI', 'Priority Boarding');
...
-- -----------------------------
-- 6. CREATE SEATS FOR ALL FLIGHTS
-- -----------------------------
DECLARE
...
BEGIN
    ...
    FOR flight_rec IN (SELECT flight_id FROM main_flightdetails ORDER BY flight_id) LOOP
        flights_processed := flights_processed + 1;
        
        FOR class_rec IN (SELECT travel_class_id, capacity FROM main_travelclass ORDER BY travel_class_id) LOOP
            DECLARE
                rows_needed NUMBER := FLOOR(class_rec.capacity / seats_per_row);
            BEGIN
                FOR row_num IN 1..rows_needed LOOP
                    FOR seat_num IN 1..seats_per_row LOOP
                        BEGIN
                            INSERT INTO main_seatdetails (seat_id, travel_class_id, flight_id)
                            VALUES (
...
BEGIN
    ...
    -- Economy class
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('ECO', 'MEAL', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    
    -- Business class
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('BUS', 'MEAL', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('BUS', 'WIFI', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('BUS', 'PRI', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    
    -- First class
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('FIR', 'MEAL', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('FIR', 'WIFI', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('FIR', 'ENT', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('FIR', 'EXL', 'Y', DATE '2025-01-01', DATE '2025-12-31');
    INSERT INTO main_serviceoffering (travel_class_id, service_id, offered_yn, from_date, to_date) VALUES ('FIR', 'PRI', 'Y', DATE '2025-01-01', DATE '2025-12-31');
...
BEGIN
    ...
    INSERT INTO main_passenger VALUES ('P001', 'Ali', 'Khan', 'ali.khan@example.com', '03001234567', 'House 10', 'Karachi', 'Sindh', '74400', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P002', 'Ayesha', 'Ahmed', 'ayesha.ahmed@example.com', '03007654321', 'House 5', 'Lahore', 'Punjab', '54000', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P003', 'Usman', 'Malik', 'usman.malik@example.com', '03009876543', 'Sector F-8', 'Islamabad', 'Federal', '44000', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P004', 'Fatima', 'Raza', 'fatima.raza@example.com', '03005556677', 'University Road', 'Peshawar', 'KPK', '25000', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P005', 'Bilal', 'Shah', 'bilal.shah@example.com', '03003334455', 'Jinnah Road', 'Quetta', 'Balochistan', '87300', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P006', 'Sara', 'Iqbal', 'sara.iqbal@example.com', '03002223344', 'Bosan Road', 'Multan', 'Punjab', '60000', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P007', 'Ahmed', 'Hassan', 'ahmed.hassan@example.com', '03004445566', 'Gulshan-e-Iqbal', 'Karachi', 'Sindh', '75300', 'Pakistan');
    INSERT INTO main_passenger VALUES ('P008', 'Zainab', 'Akhtar', 'zainab.akhtar@example.com', '03007778899', 'Defence Housing', 'Lahore', 'Punjab', '54700', 'Pakistan');
...
BEGIN
    ...
    FOR seat_rec IN (
        ...
        JOIN main_flightdetails f ON s.flight_id = f.flight_id
    ) LOOP
        DECLARE
            final_price NUMBER;
        ...
        BEGIN
            ...
            INSERT INTO main_flightcost (seat_id, valid_from_date, valid_to_date, cost)
    ...
    FOR i IN 1..10 LOOP
        ...
        BEGIN
            ...
            FROM (
                ...
                FROM main_seatdetails s
                JOIN main_flightdetails f ON s.flight_id = f.flight_id
                JOIN main_flightcost fc ON s.seat_id = fc.seat_id
                WHERE f.departure_date_time > SYSTIMESTAMP
                AND NOT EXISTS (
                    SELECT 1 FROM main_reservation r WHERE r.seat_id = s.seat_id
                )
                ORDER BY DBMS_RANDOM.VALUE
            ) WHERE ROWNUM = 1;
            
            INSERT INTO main_reservation (reservation_id, passenger_id, seat_id, date_of_reservation) 
            VALUES ('R' || LPAD(i, 3, '0'), 'P' || LPAD(MOD(i, 8) + 1, 3, '0'), seat_id_var, SYSDATE - DBMS_RANDOM.VALUE(1, 10));
            
            INSERT INTO main_paymentstatus (payment_id, payment_status_yn, payment_due_date, payment_amount, reservation_id) 
...
DECLARE
    ...
    v_latest_date DATE;
BEGIN
    SELECT COUNT(*) INTO v_airports FROM main_airport;
    SELECT COUNT(*) INTO v_flights FROM main_flightdetails;
    SELECT COUNT(*) INTO v_seats FROM main_seatdetails;
    SELECT COUNT(*) INTO v_passengers FROM main_passenger;
    SELECT COUNT(*) INTO v_reservations FROM main_reservation;
    SELECT COUNT(*) INTO v_flight_costs FROM main_flightcost;
    SELECT MIN(TRUNC(departure_date_time)), MAX(TRUNC(departure_date_time)) 
    INTO v_earliest_date, v_latest_date FROM main_flightdetails;
