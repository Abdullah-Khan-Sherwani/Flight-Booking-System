...
ALTER TABLE Passenger MODIFY Passenger_ID VARCHAR2(255);

ALTER TABLE Reservation MODIFY Reservation_ID VARCHAR2(255);

ALTER TABLE Reservation MODIFY Passenger_ID VARCHAR2(255);

ALTER TABLE Reservation MODIFY Seat_ID VARCHAR2(255);

ALTER TABLE Payment_status MODIFY Payment_ID VARCHAR2(255);

ALTER TABLE Payment_status MODIFY Reservation_ID VARCHAR2(255);